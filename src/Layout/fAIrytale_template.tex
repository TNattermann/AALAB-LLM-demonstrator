...
\backgroundsetup{
  ...
  contents={\includegraphics[width=\paperwidth]{fAIrytale_Vorlage.png}} % Image file
}
...
\input{\story}\footnote{Diese Geschichte wurde am 03.06.2025 mit Hilfe von KI am Infostand Sozioinformatik der RPTU generiert.}
